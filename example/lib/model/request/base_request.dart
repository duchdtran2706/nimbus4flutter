...
Map<String, dynamic> _$HeaderQueryRecordToJson(HeaderQueryRecord instance) {
  ...
  ds.setByName('propertyNames', instance.propertyNames?.map((e) => e));
  return ds.toMap();
}
...
Map<String, dynamic> _$CommonRequestRecordToJson(CommonRequestRecord instance) {
  final ds = _CommonRequestRecord();
  final osRecord = _OsRecord();
  osRecord.setByName('os_id', instance.os?.osId);
  osRecord.setByName('os_version', instance.os?.osVersion);

  final appRecord = _ApplicationRecord();
  appRecord.setByName('application_id', instance.application?.applicationId);
  appRecord.setByName(
    'application_version',
    instance.application?.applicationVersion,
  );

  ds.setByName('os', osRecord);
  ds.setByName('application', appRecord);
...
class _DataSet extends DataSet {
  _DataSet() : super('') {
    ...
    setNestedRecordSchema(_OsRecord().schema!, 'os');
    setNestedRecordSchema(_ApplicationRecord().schema!, 'application');
  }
}
...
ApiRequestModel _$ApiRequestModelFromJson(Map<String, dynamic> json) {
  ...
  return ApiRequestModel(
    CommonRequestRecord.fromJson(ds.getHeader('Common')?.toMap() ?? {}),
    ds
